...
public class ChatServiceImpl implements ChatService {
    ...
    public Chat addChat(@AuthenticationPrincipal UserDetails userDetails, Chat chat) {
        String currentUser = userDetails.getUsername();
        User user1 = userRepo.findUserByUsername(currentUser);
        chat.setFirstUserName(currentUser);
        return chatRepository.save(chat);
    }

    @Override
    public Message addMessage2(Message message, int chatId) {
