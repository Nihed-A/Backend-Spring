...
public class WebSecurityConfig { // extends WebSecurityConfigurerAdapter {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/api/feedback/**").hasAnyAuthority(ERole.ROLE_CUSTOMER.toString())
                .antMatchers("/api/rate/**").hasAnyAuthority(ERole.ROLE_CUSTOMER.toString())
                .antMatchers("/swagger-ui/**").hasAnyAuthority(ERole.ROLE_CUSTOMER.toString())
